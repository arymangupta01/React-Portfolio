  ...
  return (
    <div className="home__data">
        ...
        <p className="home__description">
            Software Engineer with excellent problem-solving skills and ability to perform well in a team. Passionate about coding and how to code efficiently.
        </p>
